      ...
      {isLoggedin() ? <Navbar2 handleLogout={handleLogout} /> : <Navbar />}
        ...
        <div className="mt-80" style={{padding: '0px'}}>
          <div style={{paddingRight: '8%', paddingLeft: '8%'}}>
            ...
            <div style={{padding: '40px', background: '#def4ff', borderRadius: '20px'}}>
              <h1 className="main-color" style={{fontSize: '32px'}}><br />Abstract about used cars<br /></h1>
            ...
            <div className="row mt-80">
              <div className="col-md-6">
                <h1 style={{fontSize: '24px'}}>Difference between used cars and new cars.<br /></h1>
          ...
          <div className="mt-100" style={{background: '#0cbdff', paddingTop: '80px', paddingRight: '8%', paddingLeft: '8%', paddingBottom: '80px'}}>
            <h1>Why people want to know used cars for sale near me <br /></h1>
            <div className="mt-80">
            ...
            <div style={{padding: '40px', background: '#def4ff', borderRadius: '20px'}}>
              <h1 className="main-color" style={{fontSize: '32px'}}>How do I know which Used cars for sale in Garland, TX are convenient for me?<br /></h1>
          ...
          <div style={{paddingRight: '8%', paddingLeft: '8%'}}>
            <h1 className="mt-80">Application to know used cars for sale in Garland, TX<br /></h1>
        ...
        <div className="mt-100" style={{background: '#00bbff', paddingRight: '8%', paddingLeft: '8%', paddingBottom: '80px'}}>
          <div style={{paddingTop: '50px', paddingLeft: '0px', paddingBottom: '50px'}}>
            <h1 style={{color: 'var(--white)', fontSize: '32px'}}><br />How a person gets help for locating used cars for sale with the help of one location:<br /><br /></h1>
          ...
          <div className="row">
            <div className="col col-sm-12 col-md-6">
              <h1 style={{fontSize: '24px', color: 'var(--light)'}}>Websites for tracking the location of used cars near me:<br /><br /></h1>
        ...
        <div className="mt-100" style={{paddingRight: '8%', paddingLeft: '8%'}}>
          <h1><br />How to locate the place of used cars near me with the help of a location provider:<br /><br /></h1>
          ...
          <h1><br />How to use applications or websites to know and explore used cars for sale in Garland, TX<br /><br /></h1>
          <ul className="mt-50 w-75">
        ...
        <div className="mt-100" style={{background: '#00bbff', paddingRight: '8%', paddingLeft: '8%'}}>
          <div style={{paddingTop: '50px', paddingLeft: '0px', paddingBottom: '50px'}}>
            <h1 style={{color: 'var(--white)', fontSize: '32px'}}>Final verdict<br /><br /></h1>
